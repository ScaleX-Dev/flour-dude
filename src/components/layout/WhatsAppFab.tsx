export function WhatsAppFAB() {
  return (
    ...
    >
      <span className="pointer-events-none absolute right-full top-1/2 mr-3 -translate-y-1/2 translate-x-2 whitespace-nowrap rounded-pill bg-brown-deep px-3 py-1.5 text-xs text-cream opacity-0 transition duration-300 group-hover:translate-x-0 group-hover:opacity-100">
        Chat with us!
      </span>

      <span className="inline-flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition duration-300 group-hover:scale-[1.08]">
