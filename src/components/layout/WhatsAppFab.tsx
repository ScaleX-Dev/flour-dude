...
export function WhatsAppFAB() {
  return (
    ...
    >
      ...
      <span className="inline-flex h-12 w-12 sm:h-14 sm:w-14 items-center justify-center rounded-full bg-[var(--wa-green)] text-white shadow-lg transition duration-300 group-hover:scale-[1.08]">
